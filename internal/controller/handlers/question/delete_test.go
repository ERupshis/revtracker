...
func TestDelete(t *testing.T) {
	...
	gomock.InOrder(
		mockStorage.EXPECT().DeleteQuestionByID(gomock.Any(), gomock.Any()).Return(nil),
		mockStorage.EXPECT().DeleteQuestionByID(gomock.Any(), gomock.Any()).Return(fmt.Errorf("error")),
		mockStorage.EXPECT().DeleteQuestionByID(gomock.Any(), gomock.Any()).Return(errors.ErrNoContent),
	)
