...
func (r *Reform) InsertHomeworkQuestion(ctx context.Context, homeworkQuestion *data.HomeworkQuestion) error {
	return r.insertOrUpdateHomeworkQuestion(ctx, homeworkQuestion)
}
...
func (r *Reform) insertOrUpdateHomeworkQuestion(ctx context.Context, homeworkQuestion *data.HomeworkQuestion) error {
